#!/usr/bin/env python3
"""Mac CPU/XNNPACK latency for the bekko-embedding-v1-a25m LiteRT artifacts.

    python bench_bekko_embed.py <out_dir> [--variants wi8fc,embt8,fp16]
...
def main():
    ...
    ap.add_argument("--variants", default="wi8fc,embt8,fp16")
