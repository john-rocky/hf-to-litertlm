#!/usr/bin/env python3
"""Mac CPU/XNNPACK latency for the harrier-oss-v1-0.6b LiteRT artifacts.

    python bench_harrier_embed.py <out_dir> [--variants wi8fc,fp16]
...
def main():
    ...
    for v in args.variants.split(","):
        ...
        for S in [int(s) for s in args.seqs.split(",")]:
            ...
            x[0, :n] = np.random.default_rng(0).integers(10, 151000, n)
            m[0, :n] = 1
