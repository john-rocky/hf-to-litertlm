...
#     --domain-identifier com.bonsai.devicetest
...
APP="$HOME/Library/Developer/Xcode/DerivedData/BonsaiApp-gyiusgdnpytasseefpjxcaufqapn/Build/Products/Release-iphoneos/BonsaiApp.app"
